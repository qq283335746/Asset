...
namespace TygaSoft.WcfService
{
    ...
    public interface ISecurity
    {
        ...
        ResResultModel ValidateUser(LoginFmModel model);
        ...
        [OperationContract(Name = "GetSiteMultiList")]
        ResResultModel GetSiteMultiList(ListModel model);

        [OperationContract(Name = "SaveSiteMulti")]
        ResResultModel SaveSiteMulti(SiteMultiModel model);

        [OperationContract(Name = "DeleteSiteMulti")]
        ResResultModel DeleteSiteMulti(string itemAppend);
