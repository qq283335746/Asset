    ...
    public partial class Blank : System.Web.UI.MasterPage
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            if (isPrint)
            {
                ...
                SelectPdfConvert.HtmlToPdf(new HtmlToPdfInfo(myWriter.ToString(), Request.Url.AbsoluteUri, width, height, sizeFWidth, sizeFHeight, marginTop, marginRight, marginBottom, marginLeft));
            }
            else
            {
                base.Render(writer);
