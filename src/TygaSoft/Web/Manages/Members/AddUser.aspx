...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="fl mr10">
        <div class="easyui-panel" title="创建用户" style="padding:10px;width:410px;"> 
            <div class="row">
                <span class="fl rl w100"><b class="cr">*</b>用户名：</span>
                <div class="fl">
                    <input type="text" id="txtUserName" maxlength="50"  tabindex="1" class="easyui-validatebox txt w200" data-options="required:true" />
                </div>
                <span class="clr"></span>
            </div>
            <div class="row mt10">
                <span class="fl rl w100"><b class="cr">*</b>设置密码：</span>
                <div class="fl">
                    <input type="password" id="txtPsw" maxlength="50" tabindex="2" class="easyui-validatebox txt w200" data-options="required:true" />
                </div>
                <span class="clr"></span>
            </div>
            <div class="row mt10">
                <span class="fl rl w100"><b class="cr">*</b>确认密码：</span>
                <div class="fl">
                    <input type="password" id="txtCfmPsw" maxlength="30" tabindex="3" class="easyui-validatebox txt w200" data-options="required:true" validType="cfmPsw['#txtPsw']" />
                </div>
                <span class="clr"></span>
            </div>
            <div class="row mt10">
                <span class="fl rl w100">&nbsp;</span>
                <div class="fl">
    ...
    <div id="dgRoleToolbar" style="padding:5px;">
        为此用户选择角色: 
    </div>
    <table id="dgRole" class="easyui-datagrid" title="角色" data-options="fitColumns:true,rownumbers:true,singleSelect:true,toolbar:'#dgRoleToolbar'", style="width:300px;">
        <thead>
        <tr>
            <th data-options="hidden:true,field:'IsInRole'"></th>
            <th data-options="field:'RoleName',width:400,formatter:currFun.RoleFormatter"></th>
        </tr>
    </thead>
    </table>
    <span class="clr"></span>
