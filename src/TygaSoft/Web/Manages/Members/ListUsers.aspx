...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center',title:''">
            <div id="toolbar" style="padding: 5px;">
                <a id="lbtnAdd" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="ListUser.Add()">新建</a>
                <a id="lbtnDel" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="ListUser.Del()">删除</a>
                <a id="lbtnResetPsw" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListUser.ResetPassword()">重置密码</a>
                <a id="lbtnEditAuth" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListUser.UserAccess()">用户授权</a>
                <a id="lbtnEditProfile" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="ListUser.SetUserProfile()">用户个性化</a>
                <div class="fr">
                    ...
                    <asp:Repeater ID="rpData" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="javascript:void(0)" onclick="ListUser.OnIsLockedOut(this)" code='<%#Eval("UserName") %>' class="abtn"><%#Eval("IsLockedOut").ToString() == "True" ? "已锁定":"正常" %></a></td>
    ...
    <script type="text/javascript" src="/Asset/Scripts/Manages/Members/ListUser.js"></script>
    <script type="text/javascript" src="/Asset/Scripts/Manages/Sys/SiteMulti.js"></script>
