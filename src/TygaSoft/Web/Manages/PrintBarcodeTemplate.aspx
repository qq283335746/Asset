...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div id="printBtns" style="text-align:center;padding:10px;">
        <a class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-print'" onclick="PrintBarcode.OnPrint()"><span>打印</span></a>
    </div>
    <asp:Literal ID="ltrHtml" runat="server" />

    <script type="text/javascript" src="/asset/Scripts/Manages/Prints/PrintBarcode.js"></script>
