<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDics.aspx.cs" Inherits="TygaSoft.Web.Manages.Bases.AddDics" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>新建/编辑数据字典信息</title>
</head>
<body>
    <form id="dlgFm" runat="server">
        ...
        <div class="row mt10"><span class="rl w100"><span class="cr">*</span> 编码：</span><div class="fl">
            <input tabindex="1" id="txtCoded" class="easyui-validatebox txt w400" data-options="required:true" /></div>
        </div>
        ...
        <div class="row mt10">
            ...
            <div class="fl">
                <input tabindex="3" id="txtSort" class="easyui-validatebox txt w100" data-options="validType:'int'" />
            </div>
        </div>
