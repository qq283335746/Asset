<%@ Page Title="资产管理" Language="C#" MasterPageFile="~/Masters/Manages.Master" AutoEventWireup="true" CodeBehind="ListProduct.aspx.cs" Inherits="TygaSoft.Web.Manages.Bases.ListProduct" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div id="dgToolbar">
        <a class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="Product.Add()"><span>新增</span></a> 
        <a class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" onclick="Product.Edit()"><span>编辑</span></a> 
        <a class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick="Product.Del()"><span>删除</span></a>
        <a class="easyui-menubutton" data-options="menu:'#mmExcel',iconCls:'icon-edit'">导入/导出</a>
        <a style="display:none;" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-print'" onclick="Product.Print()"><span>打印条码标签</span></a>
        <div id="mmExcel" style="width:150px;">
            <div><a href="/asset/Files/Template/资产导入模板.xlsx">下载导入模板</a></div>
    ...
    <table id="dg" class="easyui-datagrid" data-options="fit:true,fitColumns:false,pagination:true,rownumbers:true,singleSelect:false,border:true,striped:true,toolbar:'#dgToolbar'">
        <thead>
            <tr>
                ...
                <th data-options="field: 'StatusName', width:100,hidden:true">状态</th>
