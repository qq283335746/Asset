<%@ Page Title="条码标签模板管理" Language="C#" MasterPageFile="~/Masters/Manages.Master" AutoEventWireup="true" CodeBehind="BarcodeCtr.aspx.cs" Inherits="TygaSoft.Web.Manages.Bases.BarcodeCtr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
        ...
        <div title="模板设计" style="padding-top:10px;">
            <div class="easyui-layout" data-options="fit:true,border:false">
                ...
                <div id="pgContainer" data-options="region:'east',title:'样式属性'" style="width: 300px; padding: 5px;">
                    <table id="pgTable" data-options="fit:true,border:false, showHeader:false,showGroup:true,onEndEdit:BarcodeCtr.OnPgTableAcceptChanges" style="width: 100%;"></table>
                    <table id="pgTd" class="easyui-propertygrid" data-options="fit:true,border:false,showHeader: false,showGroup: true,autoRowHeight:false,onBeforeEdit:BarcodeCtr.OnTdBeforeEdit,onEndEdit:BarcodeCtr.OnPgTdAcceptChanges" style="width: 100%;"></table>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/asset/Scripts/Manages/Bases/BarcodeTemplate.js"></script>
    <script src="/asset/Scripts/Manages/Bases/BarcodeCtr.js"></script>
