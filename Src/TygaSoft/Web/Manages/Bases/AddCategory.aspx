<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCategory.aspx.cs" Inherits="TygaSoft.Web.Manages.Bases.AddCategory" %>
...
<body>
    <form id="dlgFm" runat="server">
        <div class="row">
            <span class="rl w100">上级分类：</span>
            <div class="fl">
                <span id="lbParentName"></span>
                <input type="hidden" id="hParentId" />
            </div>
        </div>
        <div class="row mt10"><span class="rl w100"><span class="cr">*</span> 分类编码：</span><div class="fl">
            <input tabindex="1" id="txtCoded" class="easyui-validatebox txt w200" data-options="required:true" /></div>
        </div>
        <div class="row mt10"><span class="rl w100"><span class="cr">*</span> 分类名称：</span><div class="fl">
