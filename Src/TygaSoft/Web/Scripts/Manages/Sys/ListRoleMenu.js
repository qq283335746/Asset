var ListRoleMenu = {
    ...
    LoadTgMenu: function () {
        ...
        var postData = '{"model":{"AllowRole":"' + allowRole + '","DenyUser":"' + denyUser + '"}';
        var url = Common.AppName + "/Services/SecurityService.svc/GetMenusTreeGrid";
    ...
    OnSave: function () {
        ...
        Common.AjaxPost("/Asset/h/content.html", postData, function (result) {
