...
namespace TygaSoft.SqlServerDAL
{
    public partial class OrgDepmt : IOrgDepmt
    {
        ...
        public int Insert(OrgDepmtInfo model)
        {
            ...
            sb.Append(@"insert into OrgDepmt (AppCode,UserId,DepmtId,ParentId,Coded,Named,Step,Sort,Remark,RecordDate,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"insert into OrgDepmt (Id,AppCode,UserId,DepmtId,ParentId,Coded,Named,Step,Sort,Remark,RecordDate,LastUpdatedDate)
			            values
